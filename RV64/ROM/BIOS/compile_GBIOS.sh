...
$ARCH-elf-gcc -fwhole-program -ffunction-sections -fdata-sections -fno-unroll-loops -Os -fno-builtin -fno-pic $CPUOPTS -c -o build/code.o c/GBIOS.c
...
$ARCH-elf-objcopy -O binary build/code.elf ../GBIOS.bin
