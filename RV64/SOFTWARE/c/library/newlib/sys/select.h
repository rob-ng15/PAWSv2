...
#define select(a,b,c,d,e) paws_select(a,b,c,d,e)
extern unsigned int paws_select(int __n, fd_set *__readfds, fd_set *__writefds, fd_set *__exceptfds, struct timeval *__timeout);
