...
#ifdef __cplusplus
extern void *cpp_paws_memcpy( void *, const void *, size_t );
extern void *cpp_paws_memset( void *destination, int value, size_t count );
#define memcpy(a,b,c)           cpp_paws_memcpy(a,b,c)
#define memset(a,b,c)           cpp_paws_memset(a,b,c)
#else
