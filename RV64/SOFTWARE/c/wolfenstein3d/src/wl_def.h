...
#define	PlaySoundLocTile(s,tx,ty)	PlaySoundLocGlobal(s,(uintptr_t)((tx<<6)|(ty)),(((long)(tx) << TILESHIFT) + (1L << (TILESHIFT - 1))),(((long)ty << TILESHIFT) + (1L << (TILESHIFT - 1))))
#define	PlaySoundLocActor(s,ob)		PlaySoundLocGlobal(s,(uintptr_t)ob,(ob)->x,(ob)->y)
