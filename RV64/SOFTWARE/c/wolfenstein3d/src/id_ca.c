...
char extension[5];
#define gheadname "/DEMO/ID1/WOLF3D/vgahead."
#define gfilename "/DEMO/ID1/WOLF3D/vgagraph."
#define gdictname "/DEMO/ID1/WOLF3D/vgadict."
#define mheadname "/DEMO/ID1/WOLF3D/maphead."
#define gmapsname "/DEMO/ID1/WOLF3D/gamemaps."
#define aheadname "/DEMO/ID1/WOLF3D/audiohed."
#define afilename "/DEMO/ID1/WOLF3D/audiot."
#define pfilename "/DEMO/ID1/WOLF3D/vswap."
...
static void PML_OpenPageFile()
{
	...
	fprintf(stderr,"PML_OpenPageFile: %s\n",fname);
	if (PageFile == -1)
