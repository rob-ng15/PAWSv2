...
#include <stdlib.h>
#include <ctype.h>
static int icvt_f(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_x(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_sq(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_c(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_d(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_i(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_n(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_o(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_p(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_s(FL_FILE *f, va_list *args, int store, int width, int type);
static int icvt_u(FL_FILE *f, va_list *args, int store, int width, int type);
static int (*icvt[])(FL_FILE *, va_list *, int, int, int)={
...
#define	ngetc(f)		(nread++, paws_fgetc(f))
#define	nungetc(c, f)		(--nread, paws_ungetc((c), f))
...
int paws_vfscanf(FL_FILE *f, const char *s, va_list args){
 ...
 */
static int icvt_fixed(FL_FILE *f, va_list *args,
