...
void WI_drawStats(void)
{
    ...
    V_DrawPatch(SP_TIMEX, SP_TIMEY, FB, time_sucks);
...
void WI_loadData(void)
{
    ...
    // "time"
    time_sucks = (patch_t*)W_CacheLumpName("WITIME", PU_STATIC);
...
void WI_unloadData(void)
{
    ...
    Z_ChangeTag(time_sucks, PU_CACHE);
