...
$ARCH-elf-gcc -fwhole-program -ffunction-sections -fdata-sections -fno-unroll-loops -Os -fno-builtin -fno-pic -march=rv32imafdc_zba_zbb_zbc_zbs_zbkb_zbkx_zifencei -mabi=ilp32f -mshorten-memrefs -mrelax -c -o build/code.o c/VBIOS.c
$ARCH-elf-gcc -Os -fno-pic -march=rv32imafdc_zba_zbb_zbc_zbs_zbkb -mabi=ilp32f -c -o build/crt0.o crt0.c
