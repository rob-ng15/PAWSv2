...
$ARCH-elf-gcc -fwhole-program -ffunction-sections -fdata-sections -fno-unroll-loops -Os -finline -fno-builtin -fno-pic -march=rv32imafc -mabi=ilp32f -c -o build/code.o c/BIOS.c
