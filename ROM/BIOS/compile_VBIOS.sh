...
$ARCH-elf-gcc -fwhole-program -ffunction-sections -fdata-sections -fno-unroll-loops -Os -fno-builtin -fno-pic -march=rv32imafc -mabi=ilp32f -mshorten-memrefs -mrelax -c -o build/code.o c/VBIOS.c
