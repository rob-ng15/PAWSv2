...
// MODIFICATIONS FOR PAWS
#include "library/PAWSlibrary.h"

#include "libforth/libforth.h"
#include "libforth/unit.h"
#include <assert.h>
#include <errno.h>
#include <ctype.h>
#include <limits.h>
...
#include "libforth/libforth.c"
#include "libforth/unit.c"
...
{
    // Connected to SDCARD for fat_io_lib
    initSDCARD();
	...
	enum forth_debug_level verbose = FORTH_DEBUG_ALL; /* verbosity level FORTH_DEBUG_OFF */
    ...
    // INITIALISE TERMINAL WINDOW - USE SIMPLE CURSES FROM PAWS
    initscr(); autorefresh( TRUE );
    ...
    // READ THE DEFAULT .fth FILES TO PROVIDE THE ENVIRONMENT
    // eval_file(o,"/COMPUTER/forth.fth",verbose);
    // eval_file(o,"/COMPUTER/editor.fth",verbose);
